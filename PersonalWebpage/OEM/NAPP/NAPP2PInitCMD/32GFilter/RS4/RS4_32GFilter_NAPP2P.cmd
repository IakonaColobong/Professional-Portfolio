...
if exist 32GAppFilterRS4_Found.tag del /f /q 32GAppFilterRS4_Found.tag
...
if not exist .\32GAppFilterRS4_Found.tag (
	ECHO !DATE! !TIME![Log TRACE]  image no support 32G App filter_RS4, goto :END
	goto :END
)
