...
if exist 32GAppFilterRS3_Found.tag del /f /q 32GAppFilterRS3_Found.tag
...
if not exist .\32GAppFilterRS3_Found.tag (
	ECHO !DATE! !TIME![Log TRACE]  image no support 32G App filter_RS3, goto :END
	goto :END
)
